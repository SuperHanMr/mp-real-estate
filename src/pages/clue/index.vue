          ...
          <view class="list-container" v-if="currentIndex == 1">
            ...
            >
              <view class="header">
                ...
                <image
                  class="image-cover"
                  :src="browerItem.estateImg"
                  mode="aspectFill"
                />
                <view class="content-warp">
                  <view class="projectName">{{ browerItem.estateName }}</view>
                  <view class="customerName" v-if="storeData.role == 1">
                    报名用户：{{ browerItem.userNickName }}/{{
                      browerItem.phoneNum
                    }}</view
                  >
                </view>
              ...
              <view class="bottomInfo">
                <view class="itemInfo">
                  ...
                  <view class="right">{{
                    formatDate(browerItem.browseTime)
                  }}</view>
                </view>
              </view>
            </view>
